...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    app.get('/api/users/:userId', function UsersController_getUser(request, response, next) {
        const args = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post('/api/users', function UsersController_createUser(request, response, next) {
        const args = {
